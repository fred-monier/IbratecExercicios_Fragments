...
public class AeronavesRelatorioListaAsaFixaFragment extends Fragment {

    public static final String TAG = "TagListaAsaFixa";
    ...
    public static AeronavesRelatorioListaAsaFixaFragment novaInstancia() {
        return new AeronavesRelatorioListaAsaFixaFragment();
    }
    ...
    private void pesquisar() {
        ...
        ArrayList<Aeronave> resultado = (ArrayList<Aeronave>) aeronaveDAO.buscarAeronavesPorAsaFixa(true);
