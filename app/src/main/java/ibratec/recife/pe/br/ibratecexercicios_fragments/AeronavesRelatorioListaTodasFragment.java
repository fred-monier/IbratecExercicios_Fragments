...
public class AeronavesRelatorioListaTodasFragment extends Fragment {

    public static final String TAG = "TagListaTodas";
    ...
    public static AeronavesRelatorioListaTodasFragment novaInstancia() {
        return new AeronavesRelatorioListaTodasFragment();
    }
    ...
    private void pesquisar(String modelo) {
        ...
        ArrayList<Aeronave> resultado = (ArrayList<Aeronave>) aeronaveDAO.buscarAeronavesPorModelo(null);
